...
?>
			...
			<div class="text-inner-banner-one pos-r">
				...
				<div class="container">
					<p>project</p>
					<h2 class="pt-30 pb-15">Project</h2>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="blog-post-block-two mb-75 md-mb-60">
								<div class="img-holder"><img src="image/5e35243fe12322.jpg" alt=""></div>
								<div class="post">
									<ul class="post-info">
										<li><a href="#">Graphics Design .</a></li>
										<li><a href="#">23 July, 2018</a></li>
									</ul>
									<h4><a href="project-details">Challange yourself & win the future.</a></h4>
									<p>This response is important for our ability to learn from mistake, but it alsogives rise to self-criticism...</p>
									<a href="project-details" class="read-more inline-button-one">Continue Reading</a>
								</div> <!-- /.post -->
